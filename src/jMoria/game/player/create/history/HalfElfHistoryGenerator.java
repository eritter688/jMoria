...
public class HalfElfHistoryGenerator extends AbstractHistoryGenerator {
  ...
  public HalfElfHistoryGenerator() {
    ...
    ancestry_one.add(new HistoryObject("Your mother was a Green-Elf.  ", 50));
    ancestry_one.add(new HistoryObject("Your father was a Green-Elf.  ", 55));
    ancestry_one.add(new HistoryObject("Your mother was a Grey-Elf.  ", 55));
    ancestry_one.add(new HistoryObject("Your father was a Grey-Elf.  ", 60));
    ancestry_one.add(new HistoryObject("Your mother was a High-Elf.  ", 65));
    ancestry_one.add(new HistoryObject("Your father was a High-Elf.  ", 70));
    historyList.add(ancestry_one);

    ancestry_two.add(new HistoryObject("You are the illegitimate and unacknowledged child ", 25));
    ancestry_two.add(new HistoryObject("You are the illegitimate but acknowledged child ", 35));
    ancestry_two.add(new HistoryObject("You are one of several children ", 45));
    ancestry_two.add(new HistoryObject("You are the first child ", 50));
