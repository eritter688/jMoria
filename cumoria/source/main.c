...
#else
#ifdef ARC_RISCOS2
/* exaclty the same as if it were int main() but */
/* the Arc also calls this as a normal procedure */
...
#if !defined(AMIGA) && !defined(ATARIST_TC) && !defined(ARC_RISCOS2)
#if !defined(atarist)
  if (0 != setuid(getuid()))
    {
