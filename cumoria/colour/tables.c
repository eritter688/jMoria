...
/*#ifndef ARC_RISCOS2*/
/* These are already defined in externs so this is to remove any
   needless complaining by the Archimedes compiler */
#ifndef MAC
...
char potion_colour[MAX_COLORS] = {
  Colour_Icky_Green, Colour_Light_Brown, Colour_Clear,
  Colour_Azure, Colour_Blue, Colour_Blue, Colour_Black, Colour_Brown,
  Colour_Brown, Colour_Bubbling, Colour_Chartreuse, Colour_Cloudy,
  Colour_Copper, Colour_Crimson, Colour_Cyan, Colour_Dark_Blue,
  Colour_Dark_Green, Colour_Dark_Red, Colour_Gold, Colour_Green,
  Colour_Green, Colour_Medium_Grey_High, Colour_Medium_Grey_Low,
  Colour_Hazy, Colour_Indigo, Colour_Light_Blue, Colour_Light_Green,
  Colour_Magenta, Colour_Metallic_Blue, Colour_Metallic_Red,
  Colour_Metallic_Green, Colour_Metallic_Purple, Colour_Misty,
  Colour_Orange, Colour_Orange, Colour_Pink, Colour_Pink, Colour_Puce,
  Colour_Purple, Colour_Purple, Colour_Red, Colour_Red, Colour_Silver,
  Colour_Smoky, Colour_Tangerine, Colour_Violet, Colour_Vermilion,
  Colour_White, Colour_Yellow
};

char mushroom_colour[MAX_MUSH] = {
  Colour_Blue, Colour_Black, Colour_Black, Colour_Brown, Colour_Dark_Blue,
  Colour_Dark_Green, Colour_Dark_Red, Colour_Ecru, Colour_Furry, 
  Colour_Green, Colour_Medium_Grey_High, Colour_Light_Blue,
  Colour_Light_Green, Colour_Plaid, Colour_Red, Colour_Slimy, Colour_Tan,
  Colour_White, Colour_White, Colour_Wooden, Colour_Wrinkled,
  Colour_Yellow
};

char wood_colour[MAX_WOODS] = {
  Colour_Aspen, Colour_Balsa, Colour_Banyan, Colour_Birch, Colour_Cedar,
  Colour_Cottonwood, Colour_Cypress, Colour_Dogwood, Colour_Elm,
  Colour_Eucalyptus, Colour_Hemlock, Colour_Hickory, Colour_Ironwood,
  Colour_Locust, Colour_Mahogany, Colour_Maple, Colour_Mulberry,
  Colour_Oak, Colour_Pine, Colour_Redwood, Colour_Rosewood, Colour_Spruce,
  Colour_Sycamore, Colour_Teak, Colour_Walnut
};

char metal_colour[MAX_METALS] = {
  Colour_Aluminum, Colour_Cast_Iron, Colour_Chromium, Colour_Copper,
  Colour_Gold, Colour_Iron, Colour_Magnesium, Colour_Molybdenum,
  Colour_Nickel, Colour_Rusty, Colour_Silver, Colour_Steel, Colour_Tin,
  Colour_Titanium, Colour_Tungsten, Colour_Zirconium, Colour_Zinc,
  Colour_Aluminum, Colour_Copper, Colour_Gold, Colour_Nickel,
  Colour_Silver, Colour_Steel, Colour_Tin, Colour_Zinc
};

char rock_colour[MAX_ROCKS] = {
  Colour_Alexandrite, Colour_Amethyst, Colour_Aquamarine, Colour_Azurite,
  Colour_Beryl, Colour_Bloodstone, Colour_Calcite, Colour_Carnelian,
  Colour_Corundum, Colour_Diamond, Colour_Emerald, Colour_Fluorite,
  Colour_Garnet, Colour_Granite, Colour_Jade, Colour_Jasper,
  Colour_Lapis_Lazuli, Colour_Malachite, Colour_Marble, Colour_Moonstone,
  Colour_Onyx, Colour_Opal, Colour_Pearl, Colour_Quartz, Colour_Quartzite,
  Colour_Rhodonite, Colour_Ruby, Colour_Sapphire, Colour_Tiger_Eye,
  Colour_Topaz, Colour_Turquoise, Colour_Zircon
};

char amulet_colour[MAX_AMULETS] = {
  Colour_Amber, Colour_Driftwood, Colour_Coral, Colour_Agate, Colour_Ivory,
  Colour_Obsidian, Colour_Bone, Colour_Brass, Colour_Bronze, Colour_Pewter,
  Colour_Tortoise_Shell
};
